...
export default function ProductIncoary({ onClose }) {
  ...
  const ProductItems = Products?.product_items || [];
        ...
        <form className="grid gap-4" onSubmit={handleSubmit(onSubmit)} >
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              className={`w-full rounded-2xl border bg-[#fbfdfc] px-3.5 py-3.5 ${errors.screenSize
                ? "border-red-500"
          ...
          <button
            // disabled={!isDirty}
            type="submit"
            className=" disabled:opacity-50 disabled:cursor-not-allowed mt-1 w-full rounded-full bg-gradient-to-r from-[#005582] to-[#185d83] px-6 py-4 text-[15px] font-bold text-white shadow-md transition hover:opacity-90 cursor-pointer"
          >
            Send Inquiry
          </button>
